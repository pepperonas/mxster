// mxster Game Card - I'd Do Anything For Love
...
// Song information
song_year = "1993";
song_title_line1 = "I'd Do";
song_title_line2 = "Anything For Love";
song_title_is_split = true;
song_artist = "Meat Loaf";
...
module qr_code_pattern(size, depth) {
    scale([size/50, size/50, 1]) {
        ...
        translate([19, 2, 0]) cube([1, 1, depth]);
        ...
        translate([29, 16, 0]) cube([1, 1, depth]);
        ...
        translate([29, 17, 0]) cube([1, 1, depth]);
        ...
        translate([5, 18, 0]) cube([1, 1, depth]);
        translate([8, 18, 0]) cube([1, 1, depth]);
        translate([13, 18, 0]) cube([1, 1, depth]);
        translate([14, 18, 0]) cube([1, 1, depth]);
        translate([16, 18, 0]) cube([1, 1, depth]);
        translate([17, 18, 0]) cube([1, 1, depth]);
        translate([22, 18, 0]) cube([1, 1, depth]);
        ...
        translate([28, 19, 0]) cube([1, 1, depth]);
        ...
        translate([25, 20, 0]) cube([1, 1, depth]);
        ...
        translate([25, 21, 0]) cube([1, 1, depth]);
        ...
        translate([26, 30, 0]) cube([1, 1, depth]);
        translate([27, 30, 0]) cube([1, 1, depth]);
        ...
        translate([35, 30, 0]) cube([1, 1, depth]);
        ...
        translate([26, 31, 0]) cube([1, 1, depth]);
        translate([27, 31, 0]) cube([1, 1, depth]);
        ...
        translate([35, 31, 0]) cube([1, 1, depth]);
        ...
        translate([3, 33, 0]) cube([1, 1, depth]);
        translate([4, 33, 0]) cube([1, 1, depth]);
        ...
        translate([3, 34, 0]) cube([1, 1, depth]);
        translate([4, 34, 0]) cube([1, 1, depth]);
        ...
        translate([22, 35, 0]) cube([1, 1, depth]);
        ...
        translate([48, 35, 0]) cube([1, 1, depth]);
        ...
        translate([16, 38, 0]) cube([1, 1, depth]);
        translate([17, 38, 0]) cube([1, 1, depth]);
