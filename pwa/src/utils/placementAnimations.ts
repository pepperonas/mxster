...
// ============================================================================
// FIRST CARD PLACEMENT - Animated Text
// ============================================================================

/**
 * Main function: Trigger first card placement animation (Animated text)
 */
export const triggerFirstCardAnimation = async (): Promise<void> => {
  ...
  textElement.className = 'first-card-text'
  textElement.textContent = '🎵 Timeline gestartet!'
  ...
  textElement.style.cssText = `
    ...
    pointer-events: none;
    opacity: 0;
    animation: text-pulse 1.5s ease-out forwards;
  `
