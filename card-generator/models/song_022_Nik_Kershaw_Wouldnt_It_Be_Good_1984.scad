// mxster Game Card - Wouldn't It Be Good
...
// Song information
song_year = "1984";
song_title_line1 = "Wouldn't";
song_title_line2 = "It Be Good";
song_title_is_split = true;
song_artist = "Nik Kershaw";
...
module qr_code_pattern(size, depth) {
    scale([size/50, size/50, 1]) {
        ...
        translate([20, 33, 0]) cube([1, 1, depth]);
        translate([21, 33, 0]) cube([1, 1, depth]);
        translate([25, 33, 0]) cube([1, 1, depth]);
        translate([26, 33, 0]) cube([1, 1, depth]);
        translate([27, 33, 0]) cube([1, 1, depth]);
        translate([29, 33, 0]) cube([1, 1, depth]);
        ...
        translate([20, 34, 0]) cube([1, 1, depth]);
        translate([21, 34, 0]) cube([1, 1, depth]);
        translate([25, 34, 0]) cube([1, 1, depth]);
        translate([26, 34, 0]) cube([1, 1, depth]);
        translate([27, 34, 0]) cube([1, 1, depth]);
        translate([29, 34, 0]) cube([1, 1, depth]);
