// mxster Game Card - The Most Beautiful Girl In the World
...
// Song information
song_year = "1995";
song_title_line1 = "The Most";
song_title_line2 = "Beautiful Girl In the World";
...
module qr_code_pattern(size, depth) {
    scale([size/50, size/50, 1]) {
        ...
        translate([8, 20, 0]) cube([1, 1, depth]);
        ...
        translate([42, 20, 0]) cube([1, 1, depth]);
        ...
        translate([8, 21, 0]) cube([1, 1, depth]);
        ...
        translate([42, 21, 0]) cube([1, 1, depth]);
